...
export function NotFoundPage() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-background flex flex-col items-center justify-center p-4 text-center transition-colors duration-300">
      <div className="w-24 h-24 bg-slate-100 dark:bg-slate-800 rounded-full flex items-center justify-center mb-6 animate-float">
      ...
      <Link to="/dashboard">
        <Button className="h-12 px-8 rounded-full bg-gradient-to-r from-sky-500 to-violet-600 hover:opacity-90 text-white shadow-lg shadow-sky-500/20">
